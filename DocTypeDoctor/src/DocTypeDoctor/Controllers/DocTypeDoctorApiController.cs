...
{
    [ApiVersion("1.0")]
    [ApiExplorerSettings(GroupName = "DocTypeDoctor")]
    public class DocTypeDoctorApiController : DocTypeDoctorApiControllerBase
    {
        private readonly IBackOfficeSecurityAccessor _backOfficeSecurityAccessor;

        public DocTypeDoctorApiController(IBackOfficeSecurityAccessor backOfficeSecurityAccessor)
        {
