...
using DocTypeDoctor.Services.Implementations;

namespace DocTypeDoctor.Composers
{
    public class DocTypeDoctorApiComposer : IComposer
    {
        public void Compose(IUmbracoBuilder builder)
        {
            ...
            builder.Services.Configure<SwaggerGenOptions>(opt =>
            {
                ...
                {
                    Title = "Doc Type Doctor Backoffice API",
                    Version = "1.0",
                ...
                opt.OperationFilter<DocTypeDoctorOperationSecurityFilter>();
            });
        }

        public class DocTypeDoctorOperationSecurityFilter : BackOfficeSecurityRequirementsOperationFilterBase
        {
        ...
        public class CustomOperationHandler : OperationIdHandler
        {
            ...
            {
                return controllerActionDescriptor.ControllerTypeInfo.Namespace?.StartsWith("DocTypeDoctor.Controllers", comparisonType: StringComparison.InvariantCultureIgnoreCase) is true;
            }
